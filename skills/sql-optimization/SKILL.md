...
description: >
  Universal SQL performance optimization guidance for query tuning, indexing, execution plans, pagination, batching, and database performance analysis. Trigger: when optimizing SQL queries, indexes, migrations, or database performance.
license: Apache-2.0
metadata:
