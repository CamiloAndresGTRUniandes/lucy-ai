...
- 🛠️ **31 new bundled skills** — covering software architecture, security review, Azure DevOps, Ignite UI Angular, C# best practices, SQL optimization, mentoring, judgment-day, git workflow, issue creation, and skill discovery/registry
...
3. **Config fragment changed:** The main agent now defaults to `openai-codex/gpt-5.5`. Your local `openclaw.json` overrides this if you have custom agent config
